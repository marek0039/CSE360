...
public class HealthPortal extends Application
{
	...
	PatientUpdateInfo pui = new PatientUpdateInfo();
	UpdateInfoConfirmation uic = new UpdateInfoConfirmation();
	PatientSummary psum = new PatientSummary();
	PatientMessagePortal pmp = new PatientMessagePortal();
	PatientSendMessage psend = new PatientSendMessage();
	...
	DocSelectPatient dsp = new DocSelectPatient();
	DocPatientSummary docSummary = new DocPatientSummary();
	DocMemoConfirmation dmc = new DocMemoConfirmation();
   	    ...
   	    public void handle(ActionEvent event)
   	    {
   	       switch(cI)
   	       {
	   	    ...
	   	    case 2: //next button on user choice screen
	   	    	...
	   	    	if(ucs.menu.getValue() == "Patient")
	   	    	{
	   	    		//if they chose patient add the patient choice screen
	   	    		root.getChildren().add(ps);
	   	    	}
	   	    	else if(ucs.menu.getValue() == "Medical Professional")
	   	    	{
